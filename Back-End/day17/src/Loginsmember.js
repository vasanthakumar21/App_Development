...
const Loginsmember = ({ errorMessages, loggedIn, login, loginError }) => {
  ...
  const renderSuccessMessage = (
    <div>
      <div>Welcome! Member<h5><b>{email}</b><FaIcons.FaHandSparkles /></h5></div>
      ...
      <div className="login-form">
        ...
        {isSubmitted ? (
          <>
            ...
            <h5><Link href="/home2" style={{ textDecoration: "none" }}>Next</Link><Link to="/home"><FaIcons.FaArrowRight style={{ marginLeft: "20px", color: "#9c6990" }} /></Link></h5>
          </>
        ) : (
            <>
              {renderForm}
