...
const Loginsleader = ({ errorMessages, loggedIn, login, loginError }) => {
  ...
  const renderSuccessMessage = (
    <div>
      <div>Welcome! Team Lead <h5><b>{email}</b><FaIcons.FaHandSparkles /></h5></div>
      ...
      <div className="login-form">
        ...
        {isSubmitted ? (
          <>
            ...
            <h5><Link href="/home" style={{ textDecoration: "none" }}>Next</Link><Link to="/home"><FaIcons.FaArrowRight style={{ marginLeft: "20px", color: "#9c6990" }} /></Link></h5>
          </>
        ) : (
            <>
              {renderForm}
